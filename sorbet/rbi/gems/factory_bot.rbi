...
class FactoryBot::Configuration
  ...
  def allow_class_lookup=(arg0); end
  ...
  def use_parent_strategy=(arg0); end
end
...
class FactoryBot::Declaration::Static < FactoryBot::Declaration
  def ==(other); end
  def build; end
  def initialize(name, value, ignored = nil); end
  def value; end
end
...
class FactoryBot::Definition
  ...
  def initialize(name = nil, base_traits = nil); end
  def initialize_copy(source); end
  def overridable; end
  def skip_create; end
...
class FactoryBot::DefinitionProxy
  def add_attribute(name, value = nil, &block); end
  def after(*args, &block); end
...
class FactoryBot::Linter
  ...
  def initialize(factories, linting_strategy, factory_strategy = nil); end
