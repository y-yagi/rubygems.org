...
class ActiveRecord::Base
  ...
  include ActiveSupport::Callbacks
  include ActiveSupport::Callbacks
  include Anonymous_ActiveRecord_AttributeMethods_GeneratedAttributeMethods_13
end
module Anonymous_ActiveRecord_AttributeMethods_GeneratedAttributeMethods_13
end
...
class ActiveRecord::ConnectionAdapters::PostgreSQLColumn < ActiveRecord::ConnectionAdapters::Column
  ...
  def initialize(*arg0, max_identifier_length: nil, **arg2); end
...
module ActiveRecord::ConnectionAdapters::PostgreSQL::SchemaStatements
  ...
  def validate_foreign_key(from_table, options_or_to_table = nil); end
end
class ActiveRecord::ConnectionAdapters::PostgreSQLTypeMetadata < Anonymous_Delegator_14
  def ==(other); end
  def array; end
  def attributes_for_hash; end
  def eql?(other); end
