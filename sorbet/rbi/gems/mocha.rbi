...
module Mocha::Integration::MiniTest::Nothing
  def self.applicable_to?(test_unit_version, ruby_version = nil); end
...
class Mocha::ParameterMatchers::QueryStringMatches < Mocha::ParameterMatchers::Base
  def explode(uri); end
...
class Mocha::Configuration
  ...
  def self.temporarily_change_config(action, new_value, &block); end
  def self.warn_when(action, &block); end
  def self.warn_when?(action); end
end
class Mocha::StubbingError < StandardError
...
class Mocha::ClassMethod
  ...
  def initialize(stubbee, method); end
