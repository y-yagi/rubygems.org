...
module Shoulda::Matchers
  ...
  def self.word_wrap(document, options = nil); end
end
...
class Shoulda::Matchers::Independent::DelegateMethodMatcher
  ...
  def register_subject_double_collection; end
  def subject; end
  def subject_delegates_to_delegate_object_correctly?; end
  def subject_double_collection; end
...
class Shoulda::Matchers::RailsShim
  ...
  def self.active_record_major_version; end
...
class Shoulda::Matchers::ActionController::RouteMatcher
  ...
  def failure_message; end
  def failure_message_when_negated; end
  def guess_controller!(controller); end
  def in_context(context); end
...
class Shoulda::Matchers::ActiveModel::ValidateInclusionOfMatcher < Shoulda::Matchers::ActiveModel::ValidationMatcher
  def allow_blank(allow_blank = nil); end
  def allow_nil(allow_nil = nil); end
  ...
  def disallows_value_outside_of_array?; end
...
class Shoulda::Matchers::ActiveModel::ValidatePresenceOfMatcher < Shoulda::Matchers::ActiveModel::ValidationMatcher
  def blank_value; end
  def collection?; end
  def disallows_and_double_checks_value_of!(value, message); end
  def disallows_original_or_typecast_value?(value, message); end
  def initialize(attribute); end
  def matches?(subject); end
  def reflection; end
...
class Shoulda::Matchers::ActiveModel::ValidateConfirmationOfMatcher < Shoulda::Matchers::ActiveModel::ValidationMatcher
  ...
  def set_confirmation(value); end
  def simple_description; end
  include Shoulda::Matchers::ActiveModel::Helpers
end
class Shoulda::Matchers::ActiveModel::ValidateNumericalityOfMatcher
  ...
  def expects_to_allow_nil?; end
  def failure_message; end
  def failure_message_for_first_failing_submatcher; end
  def failure_message_when_negated; end
  def first_failing_submatcher; end
  ...
  def submatcher_failure_message; end
  def submatcher_failure_message_when_negated; end
  def with_message(message); end
  include Shoulda::Matchers::ActiveModel::Qualifiers::IgnoringInterferenceByWriter
end
...
class Shoulda::Matchers::ActiveRecord::AssociationMatcher
  def add_submatcher(matcher); end
...
class Shoulda::Matchers::ActiveRecord::DefineEnumForMatcher
  ...
  def attribute_name; end
  def column; end
  def column_type_is_integer?; end
  def description; end
...
class Shoulda::Matchers::ActiveRecord::ValidateUniquenessOfMatcher < Shoulda::Matchers::ActiveModel::ValidationMatcher
  ...
  def all_scopes_present_on_model?; end
  def allow_blank; end
  def allow_nil; end
  def allows_blank?; end
  def allows_nil?; end
  ...
  def ensure_secure_password_set(instance); end
  ...
  def inspected_scopes_missing_on_model; end
  ...
  def should_validate_case_sensitivity?; end
  def simple_description; end
  def subject; end
  def update_existing_record!(value); end
  def validate_after_scope_change?; end
  def validate_attribute_present_on_model?; end
  def validate_case_sensitivity?; end
  def validate_scopes_match?; end
  def validate_scopes_present_on_model?; end
  def validate_two_records_with_same_non_blank_value_cannot_coexist?; end
  def validations; end
  include Shoulda::Matchers::ActiveModel::Helpers
end
